<?php 
  ...
  if (isset($_POST['addSale'])) {
    $date_of_sale = date("Y-m-d", strtotime($_POST['date']));
    $type = $_POST['type'];
    $size = $_POST['size'];
    $quantity = $_POST['quantity'];
    // $amountPerItem = $_POST['amountPerItem'];
    ...
    if ($type === "Pine") {
        ...
        $db_quantity = $row['quantity'];
         ...
         $total_quantity = $db_quantity - $quantity;
       ...
       ";
        ...
        // enter into sales
        $sale_amount = $quantity * $db_selling_price;
        $sql = "INSERT INTO sales (type_of_timber,sizes, amount_per_item, total_amount, quantity, date_of_sale)
              VALUES ('$type','$size', '$db_selling_price', '$sale_amount', '$quantity' , '$date_of_sale')";
...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="home.php">Sales</a></li>
        ...
        <div class="col-lg-6">
          <div class="card">
            <div class="card-body">
              ...
              <!-- Vertical Form -->
              <form class="row g-3" method="post" action="addSale.php">
                <div class="col-12">
                ...
                <div class="col-12">
                    ...
                    <input type="text" class="form-control" id="inputNanme4" name="quantity">
                </div>

               
               
                <!-- <div class="col-12">
                  <label for="inputNanme4" class="form-label">Amount per Item</label>
                  <input type="text" class="form-control" id="inputNanme4" name="amountPerItem">
                </div> -->
                <!-- <div class="col-12">
                  <label for="inputNanme4" class="form-label">Total Amount</label>
                  <input type="text" class="form-control" id="inputNanme4" name="totalAmount">
                </div> -->
                

                <div class="text-center">
                  <button type="submit" class="btn btn-dark" name="addSale">Add sale</button>
