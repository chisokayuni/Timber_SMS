<?php
  ...
  if (isset($_POST['addRejected'])) {
    ...
    $sql = "INSERT INTO rejected_timber (type, sizes, order_price, selling_price, rejection_reason , quantity, date_added)
                VALUES ('$type','$size', '$order_price', '$selling_price','$rejection_reason' , '$quantity', '$date_added')";
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item">Add Rejected</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-6">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Rejected Timber Details</h5>

              <!-- Vertical Form -->
              <form class="row g-3" method="post" action="addRejected.php">
                <div class="col-12">
                ...
                <div class="col-12">
                  <label for="inputNanme4" class="form-label">rejection reason</label>
                  <input type="text" class="form-control" id="inputNanme4" name="rejection_reason">
                </div>
                <div class="col-12">
                ...
                <div class="text-center">
                  <button type="submit" class="btn btn-dark" name="addRejected">Add</button>
